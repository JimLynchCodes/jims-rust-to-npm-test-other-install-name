...
console.log(`Installing and compiling jims-new-rust-cli-test 0.1.3 ${features} ...`);
exec(`cargo install jims-new-rust-cli-test --vers 0.1.3 ${features}`, (error, stdout, stderr) => {
  console.log(stdout);
  if (error || stderr) {
